...
_SYSTEM = (
    ...
    "candidate actually took. "
    "(10) " 
    "DIGITS, AND YEARS UP FRONT. Write every quantity as digits, "
    "never as words: 7+ years, not seven years. ATS filters and "
    "recruiters both key on digits, and a spelled-out number is "
    "invisible to a years-of-experience filter. When the JD states a "
    "years-of-experience requirement and the library genuinely "
    "covers it, the Professional Summary MUST state that span in "
    "digits inside its FIRST clause, right after the role title - "
    "for example: AI engineer with 7+ years building production "
    "systems... NEVER bury it behind a degree or any other "
    "credential, and never drop it. State the true span; never "
    "inflate it. "
    "(11) " 
