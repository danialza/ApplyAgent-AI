...
def generate_cover_letter(
    *,
    ...
    system = (
        ...
        "5. NO AI TELLS. A human reads this — these phrasings mark it "
        "as machine-written and get it skimmed: 'I am excited to', 'I am "
        ...
        "writing to apply'.\n"
        "6. Output PLAIN TEXT only — no markdown, no headers, no "
